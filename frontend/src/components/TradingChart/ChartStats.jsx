...
export const ChartOrdersList = memo(({ orders }) => {
  ...
  const formattedOrders = orders.map(order => ({
    ...order,
    openTimeFormatted: order.open_time ? formatServerTimeOnly(order.open_time, true) : null,
    closeTimeFormatted: order.close_time ? formatServerTimeOnly(order.close_time, true) : null,
  }));

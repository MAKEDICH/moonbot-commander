...
class UserSettingsBase(BaseModel):
    ...
    backend_log_level: int = Field(default=2, ge=1, le=4)  # 1-критические, 2-неполное, 3-полное, 4-выборочное
    log_categories: Optional[List[str]] = None  # Категории для выборочного логирования
...
class UserSettingsUpdate(BaseModel):
    ...
    backend_log_level: Optional[int] = Field(None, ge=1, le=4)  # 1-критические, 2-неполное, 3-полное, 4-выборочное
    log_categories: Optional[List[str]] = None  # Категории для выборочного логирования

...
from .filters import SensitiveDataFilter, CategoryFilter
...
def setup_logging(
    ...
    console_handler.addFilter(CategoryFilter())  # Фильтр по категориям
    ...
    # Добавляем CategoryFilter к uvicorn логгерам для выборочной фильтрации HTTP логов
    uvicorn_loggers = ['uvicorn', 'uvicorn.access', 'uvicorn.error']
    for logger_name in uvicorn_loggers:
        uvicorn_logger = logging.getLogger(logger_name)
        uvicorn_logger.addFilter(CategoryFilter())

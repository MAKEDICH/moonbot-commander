...
def get_encryption_key():
    ...
    if not key:
        print("\n" + "="*60)
        print("  [SECURITY ERROR] ENCRYPTION_KEY not set!")
        print("="*60)
...
def decrypt_password(encrypted_password: str) -> str:
    ...
    if encrypted_password.startswith('gAAAAA'):
        ...
        print(f"[ERROR] Failed to decrypt password - corrupted or wrong key")
        return ""  # Возвращаем пустую строку при ошибке
    
    # Это plain text пароль (обратная совместимость)
    print(f"[INFO] Using backward compatibility mode for server credentials")
